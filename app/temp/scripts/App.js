...
var RevealOnScroll = function () {
	function RevealOnScroll(className, offsetVal) {
		_classCallCheck(this, RevealOnScroll);

		this.className = className;
		this.offsetVal = offsetVal;
		this.itemsToReveal = (0, _jquery2.default)("." + this.className);
		this.hideInitially();
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						if (direction == "down") {
							...
							(0, _jquery2.default)(currentPageSection.getAttribute("data-matching-link")).addClass("is-current-link");
						}
					},
					offset: "18%"
				});
